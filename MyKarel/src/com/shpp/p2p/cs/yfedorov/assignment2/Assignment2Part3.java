...
public class Assignment2Part3 extends WindowProgram {
    ...
    private void drawPawprint(double x, double y) {
        ...
        // draw First left Finger
        GOval firstFinger = new GOval(FIRST_TOE_OFFSET_X + x,
        ...
        // draw Second midl Finger
        GOval secondFinger = new GOval(SECOND_TOE_OFFSET_X + x,
        ...
        // draw Third right Finger
        GOval thirdFinger = new GOval(THIRD_TOE_OFFSET_X + x,
        ...
        // draw Heel
        GOval hell = new GOval(HEEL_OFFSET_X + x,
                HEEL_OFFSET_Y + y,
                HEEL_WIDTH,
                HEEL_HEIGHT);
        hell.setFilled(true);
